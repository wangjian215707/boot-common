...
public class MessageSend implements Serializable {
    ...
    public  void sendMessage(String userid,String content,String ajid,String corpsecret){
        ...
        String msg= httpUtil.responseJsonServicePost
                ("https://qyapi.weixin.qq.com/cgi-bin/message/send?access_token="+accessTokenService.getAccessToken(corpsecret),map,null);
        LOGGER.info(msg);
    }
}
