...
public class WebRestControllerAspect {
     ...
     * @param joinPoint
     */
    @Before("webLog()||webPostLog()||webRequestLog()")
    public void doBefore(JoinPoint joinPoint){
        ...
        log.info("-----:"+ JsonUtils.toJson(aspectEntity));
    }
     ...
     * @throws Throwable
     */
    @AfterReturning(returning = "ret", pointcut = "webLog()||webPostLog()||webRequestLog()")
     ...
     * @param jp
     */
    @AfterThrowing("webLog()||webPostLog()||webRequestLog()")
     ...
     * @param jp
     */
    @After("webLog()||webPostLog()||webRequestLog()")
     ...
     * @return
     */
    @Around("webLog()||webPostLog()||webRequestLog()")
